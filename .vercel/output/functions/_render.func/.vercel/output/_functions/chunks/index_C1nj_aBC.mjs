...
import { M as MovingBorderWrapper, $ as $$ProjectTools, S as Section, H as Highlight, a as Stat, b as $$Contact } from './contact_DJEgr91b.mjs';
...
function TabContent({
  ...
  return /* @__PURE__ */ jsxs("div", { className: " p-m sm:p-2xl flex gap-l flex-col items-center bg-bgColor    min-w-0 min-h-svh rounded-xl ", children: [
    /* @__PURE__ */ jsx("h5", { children: header }),
    /* @__PURE__ */ jsx("p", { className: "prose-p  ", children: description }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-row gap-m sm:gap-2xl items-center align-middle justify-start w-full  z-10 flex-wrap sm:max-w-2xl mt-xl", children: stats && stats.map((statItem, index) => /* @__PURE__ */ jsx(
      Stat,
      {
...
const $$Solution = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", Section, { "client:visible": true, "idName": "solution", "title": "The Solution", "backgroundColor": "accent", "minHeight": "160svh", "className": "flex flex-col items-center min-h-max ", "client:component-hydration": "visible", "client:component-path": "@/components/ui/section", "client:component-export": "Section" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="h-svh items-center max-w-sm sm:container sm:mx-auto px-l sm:px-0 w-full"> ${renderComponent($$result2, "Tabs", Tabs, { "tabs": tabs, "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/atrujillo/at/src/pages/projects/bhf/_components/solution-tabs", "client:component-export": "Tabs" })} </div> ` })}`;
