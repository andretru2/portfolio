...
import { c as cn, T as Tools, a as $$Icon, b as $$ContactMe } from './layout_ZvE2r4zi.mjs';
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: /* @__PURE__ */ jsxs(
    motion.section,
    {
      ...
      className: cn(
        ...
        margin === "bottom" && "mb-xl",
        margin === "none" && "my-0",
        !skipRoundCorners && "rounded-t-[6rem] rounded-b-[6rem] border-y-1 border-t border-accent/30 stroke-[0.1] hover:stroke-[0.15]",
...
const $$ProjectTools = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="relative h-full flex shrink-0 flex-col gap-m items-center justify-center overflow-hidden" data-astro-cid-2mdeh4hv> ${[...new Array(rows)].map((row, i) => {
    return renderTemplate`${renderComponent($$result, "InfiniteLoopSlider", $$InfiniteLoopSlider, { "duration": random(43e3, 45e3), "reverse": i % 2 == 0, "data-astro-cid-2mdeh4hv": true }, { "default": ($$result2) => renderTemplate`${tools.slice(0, perRow).map((tool) => renderTemplate`<div${addAttribute(tool?.name, "aria-label")}${addAttribute(tool?.name, "title")}${addAttribute([
      "p-s rounded-xl ml-xs z-10  shadow-sm border border-white/30  shadow-white/[0.05]",
...
function Stat({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-xs items-center", children: [
    ...
    ) : /* @__PURE__ */ jsx("h5", { className: "text-accent", children: value }),
    /* @__PURE__ */ jsx("span", { className: "text-s font-light opacity-80", children: label })
  ] });
}

const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", Section, { "client:visible": true, "idName": "contact", "title": "Contact", "backgroundColor": "accent", "minHeight": "50svh", "className": "flex flex-col justify-center items-center  h-full  ", "client:component-hydration": "visible", "client:component-path": "@/components/ui/section", "client:component-export": "Section" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col items-center *:text-center gap-xl *:text-bgColor max-w-2xl"> <!-- <StaggeredText
